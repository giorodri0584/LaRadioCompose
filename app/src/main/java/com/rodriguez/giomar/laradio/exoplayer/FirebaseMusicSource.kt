...
import com.rodriguez.giomar.laradio.exoplayer.State.*
    ...
    suspend fun fetchMediaData() = withContext(Dispatchers.IO) {
        ...
        songs = allSongs.map { song ->
            MediaMetadataCompat.Builder()
                .putString(METADATA_KEY_ARTIST, song.ciudad)
                .putString(METADATA_KEY_MEDIA_ID, song.objectId)
                ...
                .putString(METADATA_KEY_DISPLAY_SUBTITLE, song.ciudad)
